...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    impactLevel: 'High',
    description: 'LLMs analyze complex legal contracts to identify risks, compliance issues, and negotiation points, informing strategic legal decisions.',
    ...
    results: '75% faster document review, 40% improvement in risk identification, 55% increase in successful contract negotiations.',
